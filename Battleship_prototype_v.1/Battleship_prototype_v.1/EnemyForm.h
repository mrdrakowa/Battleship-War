		...
		void CreateMap()
		{
			...
			for (int i = 1; i <= 10; i++)
			{
				for (int j = 1; j <= 10; j++)
				{
					...
					buttonEnemy->Click += gcnew EventHandler(this, &EnemyForm::Button_click);
			...
			buttonStart->Click += gcnew EventHandler(this, &EnemyForm::ButtonStart_click);
